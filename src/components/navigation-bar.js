...
import { StatusBarIOS, StyleSheet, Text, TouchableOpacity, View, PixelRatio } from 'react-native';
...
export default class NavigationBar extends Component {
    ...
    prevButtonShouldBeHidden(): Boolean {
        let { onPrev, hidePrev, navigator } = this.props;
    ...
    getLeftButtonElement() {
        let { onPrev, prevTitle, navigator, route, buttonsColor, customPrev } = this.props;
    ...
    getTitleElement() {
        let { title, titleColor, customTitle, navigator, route } = this.props;
    ...
    getRightButtonElement() {
        let { onNext, nextTitle, navigator, route, buttonsColor, customNext } = this.props;
